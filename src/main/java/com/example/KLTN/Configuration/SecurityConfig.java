...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(request -> request
                ...
                .requestMatchers(HttpMethod.PUT, "/user/pagination/**","/common-categories/**","/commonParentChild/**","/trade/**","/withdrawal/**","/project/updateQuantityBurn/**","sampleSent/**").permitAll()
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> {
            ...
            web.ignoring().requestMatchers(HttpMethod.PUT,"/user/**","/project/update/**","common-categories/**","/commonParentChild/**","/measurementData/update/**","/trade/**","/withdrawal/**","/project/updateQuantityBurn/**","sampleSent/**");
